...
class PaxIdentityDoc
{
    ...
    /**
     * PaxIdentityDoc constructor
     *
     * @param \Amadeus\Client\RequestOptions\Travel\OrderChange\PaxIdentityDoc $identityDoc
     */
    public function __construct($identityDoc)
    {
        $this->IdentityDocID = $identityDoc->docId;
        $this->IdentityDocTypeCode = $identityDoc->docTypeCode;
