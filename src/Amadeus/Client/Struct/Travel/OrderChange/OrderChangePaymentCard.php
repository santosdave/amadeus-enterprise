...
class OrderChangePaymentCard
{
    ...
    /**
     * OrderChangePaymentCard constructor
     *
     * @param \Amadeus\Client\RequestOptions\Travel\OrderChange\PaymentCard $paymentCard Payment card details
     */
    public function __construct($paymentCard)
    {
