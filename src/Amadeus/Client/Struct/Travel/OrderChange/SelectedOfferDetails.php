...
class SelectedOfferDetails
{
    ...
    /**
     * SelectedOfferDetails constructor
     *
     * @param \Amadeus\Client\RequestOptions\Travel\OrderChange\SelectedOffer $selectedOffer
     */
    public function __construct($selectedOffer)
    {
        $this->OfferID = $selectedOffer->offerId;
        $this->OwnerCode = $selectedOffer->ownerCode;
        $this->ShoppingResponseRefID = $selectedOffer->shoppingResponseRefId;

        foreach ($selectedOffer->selectedOfferItems as $item) {
