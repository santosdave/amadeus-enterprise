...
/**
 * Invoice Destination details
 */
class OrderPayInvoiceDestination
{
    /**
     * Email Details
     * 
     * @var OrderPayInvoiceEmailContact
     */
    public $Email;

    /**
     * OrderPayInvoiceDestination constructor
     *
     * @param string $emailContact Email address for invoice
     */
    public function __construct($emailContact)
    {
        $this->Email = new OrderPayInvoiceEmailContact($emailContact);
    }
}
