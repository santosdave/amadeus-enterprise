...
/**
 * Struct for Travel_SeatAvailability request
 *
...
class SeatAvailability extends BaseWsMessage
{
     ...
     * @param TravelSeatAvailabilityOptions $options
     */
    protected function loadParty(TravelSeatAvailabilityOptions $options)
    {
        $this->Party = new SeatAvailabilityParty(
            $options->agencyId,
     ...
     * @param TravelSeatAvailabilityOptions $options
     */
    protected function loadRequest(TravelSeatAvailabilityOptions $options)
    {
        $this->Request = new SeatAvailabilityRequest($options);
    }
}
