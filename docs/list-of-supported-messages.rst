...
- Hotel_MultiSingleAvailability (see `issue 70 <https://github.com/santosdave/amadeus-enterprise/issues/70>`_)
- Hotel_DescriptiveInfo (see `issue 70 <https://github.com/santosdave/amadeus-enterprise/issues/70>`_)
- Hotel_EnhancedPricing (see `issue 70 <https://github.com/santosdave/amadeus-enterprise/issues/70>`_)
- Hotel_Sell (see `issue 70 <https://github.com/santosdave/amadeus-enterprise/issues/70>`_)
- Hotel_CompleteReservationDetails (see `issue 70 <https://github.com/santosdave/amadeus-enterprise/issues/70>`_)
- Hotel_Terms (see `issue 70 <https://github.com/santosdave/amadeus-enterprise/issues/70>`_)
- Car_Availability
